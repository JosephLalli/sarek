...
workflow SAREK {
    ...
    */
    ...
    if (tools) {
        ...
        cram_variant_calling_tumor_filtered = cram_variant_calling_tumor_joined.filter { tuple -> !(tuple.last()) }
        bam_variant_calling_tumor_filtered = bam_variant_calling_tumor_joined.filter { tuple -> !(tuple.last()) }
        ...
        cram_variant_calling_tumor_only = cram_variant_calling_tumor_filtered.transpose().map { tuple -> [tuple[1], tuple[2], tuple[3]] }
        bam_variant_calling_tumor_only = bam_variant_calling_tumor_filtered.transpose().map { tuple -> [tuple[1], tuple[2], tuple[3]] }
        ...
        if (params.only_paired_variant_calling) {
            ...
            cram_variant_calling_normal_filtered = cram_variant_calling_normal_joined.filter { tuple -> !(tuple.last()) }
            bam_variant_calling_normal_filtered = bam_variant_calling_normal_joined.filter { tuple -> !(tuple.last()) }
            ...
            cram_variant_calling_status_normal = cram_variant_calling_normal_filtered.map { tuple -> [tuple[1], tuple[2], tuple[3]] }
            bam_variant_calling_status_normal = bam_variant_calling_normal_filtered.map { tuple -> [tuple[1], tuple[2], tuple[3]] }
        }
        else {
