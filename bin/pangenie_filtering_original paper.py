...
#			med.add(line.strip())
	...
	variant_types = {
		'snps': [snps, ['unfiltered', 'strict'], ['all-regions', 'repeat-regions', 'nonrepeat-regions']],
#		'small_insertions': [small_insertions, ['unfiltered', 'strict'], ['all-regions', 'repeat-regions', 'nonrepeat-regions']],
#		'small_deletions': [small_deletions, ['unfiltered', 'strict'], ['all-regions', 'repeat-regions', 'nonrepeat-regions']],
#		'small_complex': [small_complex, ['unfiltered', 'strict'], ['all-regions', 'repeat-regions', 'nonrepeat-regions']],
#		'midsize_deletions': [midsize_deletions, ['unfiltered', 'strict'], ['all-regions', 'repeat-regions', 'nonrepeat-regions']],
#		'midsize_insertions': [midsize_insertions, ['unfiltered', 'strict'], ['all-regions', 'repeat-regions', 'nonrepeat-regions']],
#		'midsize_complex': [midsize_complex, ['unfiltered', 'strict'], ['all-regions', 'repeat-regions', 'nonrepeat-regions']],
		'indels': [indels, ['unfiltered', 'strict'], ['all-regions', 'repeat-regions', 'nonrepeat-regions']],
		'large_deletions': [large_deletions, ['unfiltered', 'lenient_-0.5', 'strict'], ['all-regions', 'repeat-regions', 'nonrepeat-regions']],
		'large_insertions': [large_insertions, ['unfiltered', 'lenient_-0.5', 'strict'], ['all-regions', 'repeat-regions', 'nonrepeat-regions']],
		'large_complex': [large_complex, ['unfiltered', 'lenient_-0.5', 'strict'], ['all-regions', 'repeat-regions', 'nonrepeat-regions']]
