...
workflow NFCORE_SAREK {
    ...
    PREPARE_GENOME(
        ...
        params.pon,
        params.pon_tbi,
        params.pangenome_gbz,
        params.pangenome_dist,
        params.pangenome_min,
        params.pangenome_zipcodes,
        params.pangenome_ref_paths,
        params.pangenome_ri,
        params.strling_loci,
        params.aligner,
        params.step,
    ...
    SAREK(
        ...
        params.pangenome_gbz ? channel.fromPath(params.pangenome_gbz).map { gbz -> [[id: 'pangenome'], gbz] }.collect() : channel.value([[id: 'pangenome'], []]),
