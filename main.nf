...
params.graph                 = WorkflowMain.getGenomeAttribute(params, 'graph')
params.giraffe_chr_names     = WorkflowMain.getGenomeAttribute(params, 'giraffe_chr_names')
params.giraffe               = WorkflowMain.getGenomeAttribute(params, 'giraffe')
params.giraffe_dist          = WorkflowMain.getGenomeAttribute(params, 'giraffe_dist')
params.giraffe_min           = WorkflowMain.getGenomeAttribute(params, 'giraffe_min')
params.giraffe_snarls        = WorkflowMain.getGenomeAttribute(params, 'giraffe_snarls')
params.giraffe_xg_index      = WorkflowMain.getGenomeAttribute(params, 'giraffe_xg_index')
...
params.panel_vcf             = WorkflowMain.getGenomeAttribute(params, 'panel_vcf')
params.panel_vcf_bi          = WorkflowMain.getGenomeAttribute(params, 'panel_vcf_bi')
params.pangenie_model        = WorkflowMain.getGenomeAttribute(params, 'pangenie_model')
...
params.str_variant_catalog   = WorkflowMain.getGenomeAttribute(params, 'str_variant_catalog')
