...
workflow CHANNEL_MARKDUPLICATES_CREATE_CSV {
    ...
    main:
        ...
        cram_markduplicates.collectFile(keepHeader: true, skip: 1, sort: true, storeDir: "${outdir}/csv") { meta, cram_file, crai_file ->
            ...
            def file_path   = "${outdir}/preprocessing/${csv_subfolder}/${sample}/${cram_file.baseName}.${suffix_aligned}"
            def index_path   = "${outdir}/preprocessing/${csv_subfolder}/${sample}/${crai_file.baseName.minus(".cram")}.${suffix_index}"
