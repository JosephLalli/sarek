...
workflow BAM_VARIANT_CALLING_SOMATIC_STRELKA {
    ...
    cram_intervals = cram.combine(intervals)
        ...
        .map{ meta, normal_cram, normal_crai, tumor_cram, tumor_crai, manta_vcf, manta_tbi, _intervals, _intervals_index, num_intervals -> [ meta + [ num_intervals:num_intervals ], normal_cram, normal_crai, tumor_cram, tumor_crai, manta_vcf, manta_tbi, _intervals, _intervals_index ] }
